...
if __name__ == "__main__":
    ...
    group.add_argument('-d', '--decimal', type=int, action='store', help='The decimal to convert to Roman number')
    group.add_argument('-p', '--path', type=str, action='store', help='The path with file of decimal numbers to convert')
